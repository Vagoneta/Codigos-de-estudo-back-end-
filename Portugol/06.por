programa
{
	...
	funcao inicio()
	{
		...
		s = s + salario
		escreva ("\nOperário 0" ,operarios[c1], ". ", sexo[c1], ". Total de ", pecas[c1], " feitas. Salário de ", salario, " Reais")
		}
		escreva ("\nTotal de salário a pagar ou pagos para os operários nesse mês: ", s, " Reais")
		escreva ("\nMaior salário registrado de: ",maior)
		para (c2 = 0; c2 < 5; c2++){
			pecast = pecast + pecas[c2]
			}
		escreva ("\nTotal de peças feitas nesse mês: ", pecast)
	}
}
/* $$$ Portugol Studio $$$ 
 * 
